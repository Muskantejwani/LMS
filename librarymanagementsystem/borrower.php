					...
					{	
						...
						{	
							...
							if($quantity != 0){
								...
								$sql1 = "INSERT INTO borrower (studname, enrollno, program, title,  issueDate, returnDate) values('$studname', '$enrollno', '$program', '$title', '$issueDate', '$returnDate');";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="borrower.php">issue book</a>
        </li>
        <li class="nav-item">
...
<div class="container layer " id = "bottomcenter" >
        ...
        <div class="col-12 col-md-3 ">
                ...
                <div class="text-center" style="margin-right:30%; color: #500f07; padding-top:10%;"><h2>isssue book</h2></div>
                <form action="borrower.php" method = "POST">
                    <table id = "formLayout" cellspacing="10">
                        <tr id = "rowLayout"><td id="rowHeading" class="pr-1"> Student Name :  </td><td><input type="text" name="studname" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Enroll No :  </td><td><input type="text" name="enrollno" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Program :  </td><td><input type="text" name="program" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Book Name :  </td><td><input type="text" name="title" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Issue Date :  </td><td><input type="date" name="issueDate" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Return Date :  </td><td><input type="date" name="returnDate" id = "input" required></td></tr>
                    </table>
