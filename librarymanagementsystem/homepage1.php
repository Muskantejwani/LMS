...
function projects(){   
  include('connect.php');
        $sql = "SELECT SUM(quantity) From addbook";
...
<div class="container layer " id = "bottomcenter" >
	<div class="row">
            <div class="col"  style="margin-left:5%; box-shadow:0 2px 20px 0 rgba(110,130,208, 0.18); margin-bottom:15%; color:#fff; background: rgb(97, 5, 5); width:15%; height:10%; margin-right: 20%;
    margin-top: 13%;"><br>
                <strong
                style="  color:rgb(11, 153, 153);  " class="text-center"><h6 style="margin-bottom:10%; color:#fff;"><b>Date</b> : 
                <?php echo date("d-F-20y")?></h6>
                <h4 style="weight:600; font-size:20px;color:#fff; ">Total Books</h4><br>
                <h2 style="  color:#fff;"><?php echo projects();?></h2></strong></div>

                <div class="col" style="margin-right:5%; box-shadow:0 2px 20px 0 rgba(110,130,208, 0.18); color:#fff; background: rgb(97, 5, 5); width:15%; height:10%;  
    margin-top: 13%; "><br><strong
                style="  color:rgb(11, 153, 153); color:#fff; " class="text-center"><h6 style="margin-bottom:10%; "><b>Date</b> : 
                <?php echo date("d-F-20y")?></h6>
                <h4 style="weight:600; font-size:20px; color:#fff;">issued Books</h4><br>
                <h2 style=" color:#fff;"><?php echo tprojects();?></h2></strong></div>
